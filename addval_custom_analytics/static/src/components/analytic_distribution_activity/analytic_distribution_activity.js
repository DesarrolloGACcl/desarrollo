...
export class AnalyticDistributionActivity extends AnalyticDistribution {
    async fetchAllPlans(nextProps) {
        // TODO: Optimize to execute once for all records when `force_applicability` is set}
        console.log('Entro al metodo heredado de actividad')
...
registry.category("fields").add("analytic_distribution_activity", AnalyticDistributionActivity, { force: true });